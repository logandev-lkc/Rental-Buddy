...
| --- | --- | --- | --- | --- | --- |
| F-020 | 單頁 InBody PDF | 匯出文件像正式檢驗單，固定一頁 A4 | **in_progress** | **P0** | 首版已實作；待實機列印驗收 |
| F-021 | 報告手機閱讀 IA | 首屏 3 秒內看懂能不能租 | **in_progress** | **P1** | 決策首屏、Top 3、「查看全部」 |
| F-022 | 報告與 v3／查核資料對齊 | 查核怎麼填，報告就怎麼呈現 | **in_progress** | **P1** | quickStatus、formatChecklistNote |
| F-023 | 閱讀版 + 列印預覽（取代雙模式切換） | 減少「圖文／表格」混淆 | **in_progress** | P2 | **D-005** 已落地 |
| F-024 | 多房源比較降級 | 報告首屏專注單一房源決策 | **in_progress** | P2 | **D-007** 預設收合 |
